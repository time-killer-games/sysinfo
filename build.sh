...
if [ $(uname) = "Darwin" ]; then
  ...
  mkdir ../arm64 && gn gen ../arm64 && echo "target_cpu = \"arm64\"" >> args.gn && gn args ../arm64 && GYP_GENERATORS=ninja gclient runhooks && ninja -j 10 -k1 -C ../arm64;
  mkdir ../x86_64 && gn gen ../x86_64 && echo "target_cpu = \"x86_64\"" >> args.gn && gn args ../x86_64 && GYP_GENERATORS=ninja gclient runhooks && ninja -j 10 -k1 -C ../x86_64;
