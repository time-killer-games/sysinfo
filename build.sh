...
if [ $(uname) = "Darwin" ]; then
  sudo port install libsdl2 +universal python3 ninja && git clone https://chromium.googlesource.com/angle/angle && git clone https://chromium.googlesource.com/chromium/tools/depot_tools;
