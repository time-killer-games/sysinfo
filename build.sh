...
if [ $(uname) = "Darwin" ]; then
  ...
  git fetch --tags && mkdir ../arm64 && gn gen ../arm64 && echo "target_cpu = \"arm64\"" >> args.gn && GYP_GENERATORS=ninja gclient runhooks && ninja -j 10 -k1 -C ../arm64 && mkdir ../x86_64 && gn gen ../x86_64 && echo "target_cpu = \"x86_64\"" >> args.gn && GYP_GENERATORS=ninja gclient runhooks && ninja -j 10 -k1 -C ../x86_64;
